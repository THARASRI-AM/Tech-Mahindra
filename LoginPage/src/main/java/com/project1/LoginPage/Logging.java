    ...
    public static void main(String[] args) {
        try {
            ...
            while (true) {
                ...
                String checkUserSQL = "SELECT * FROM THARA.LoginCredentials WHERE Username = '" + username + "'";
                ...
                if (rs.next()) {
                    ...
                    String checkPasswordSQL = "SELECT * FROM THARA.LoginCredentials WHERE Username = '" + username + "' AND Password = '" + password + "'";
                    ...
                    String insertUserSQL = "INSERT INTO THARA.LoginCredentials (Username, Password) VALUES ('" + username + "', '" + newPassword + "')";
                    try {
